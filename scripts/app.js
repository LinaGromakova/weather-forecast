...
async function getWeather() {
  ...
  if (!response.ok) {
    ...
    <div class="error-wrapper">
      <h1 class="error-title el-anim">404</h1>
      <h3 class="error-subtitle el-anim">Not Found</h3>
      <p class="error-par el-anim">Maybe you're wrong. Try again</p>
    </div>
    `;
  ...
  generateHTML = `
    <div class="wrapper">
      <img class="el-anim " src="img/icons/${
        response.weather[0].main
      }-${date}.webp" alt="weather-icon" />
      <div class="temperature el-anim">
        <span>${Math.floor(response.main.temp).toFixed(0)}</span>
        <span class="celsius">℃</span>
      </div>
      <h3 class=" el-anim ">${response.weather[0].main}</h3>
      <div class="column-wrapper-values">
      <div class="column-values el-anim_left">
        <div class="column">
      ...
      <div class="column-values el-anim_right">
        <div class="column">
